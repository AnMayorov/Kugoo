...
<body>
  <div class="wrapper">
    <div class="mobile__menu">
      <h3 class="mobile__menu-title">
        Каталог товаров
      </h3>

      <ul class="mobile__menu-list mobile-first-list">
      ...
      <div class="mobile__info-box flex">
        <ul class="mobile__info-list flex">
          <li class="mobile__info-item">
            <p class="mobile__info-text">
              Call-центр
            </p>
            <a href="tel:+78005055461" class="mobile__phone">+7 (800) 505-54-61</a>
            <span class="mobile__info-span">
              Пн-Вс 10:00 - 20:00
            </span>
          </li>
          <li class="mobile__info-item">
            ...
            <a href="tel:+74993507692" class="mobile__phone">+7 (499) 350-76-92</a>
            <span class="mobile__info-span">
              Пн-Вс 10:00 - 20:00
            </span>
          </li>
          <li class="mobile__info-item mobile-social flex">
            <a class="mobile__info-link flex" href="https://" target="_blank">
            ...
            <a href="https://" class="mobile__info-link flex" target="_blank">
              <svg class="mobile__svg">
        ...
        <a href="#" class="mobile__call-link">
          Заказать звонок
        </a>
      </div>
    </div>
    <nav class="header__nav nav">
      <div class="nav__container flex">
        <svg class="header__logo-svg mobile-logo">
        ...
        <a href="tel:+78005055461" class="nav__phone">+7 (800) 505-54-61</a>
      </div>
    </nav>
    ...
    <header class="header">
      <div class="header__container">
        <div class="header__form flex">
          ...
          <div class="header__form-box flex">
            ...
            <form action="#" method="POST" class="header__search-form form flex">
              <input class="form__input" type="text" id="search_form" name="searchform" placeholder="Искать самокат KUGO"
      ...
      <section class="riding">
        <div class="riding__content flex">
          ...
          <div class="riding__info">
            <h2 class="riding__title title-visible title">
              Научим правильной <span>и безопасной езде в городе</span> вас или вашего ребенка
            </h2>
            <h2 class="riding__title title-hidden title">
